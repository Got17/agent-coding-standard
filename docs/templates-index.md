# Copy-Paste AGENTS.md Templates

> Copy these ready-to-use templates directly into your target project's `AGENTS.md` file so AI agents automatically follow production standards.
